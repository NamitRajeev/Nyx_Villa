      ...
      <div className="section-shell relative z-10 w-full pb-14 pt-24 sm:pb-20 lg:pb-24">
        <Reveal className="max-w-2xl">
          ...
          <h1
            ...
            id="hero-heading"
          >
            Private. Gilded. <em className="font-medium text-nyx-pale-gold">Entirely yours.</em>
          </h1>
          <p className="mt-7 max-w-lg text-pretty text-base leading-8 text-nyx-ivory/78 sm:text-lg">
            A private villa stay shaped by deep water, warm light, and quiet design.
          </p>
        ...
        <a
          ...
          href="#villa"
        >
          Discover NYX <ArrowDown aria-hidden="true" className="size-4" strokeWidth={1.5} />
        </a>
      </div>
    </section>
  );
